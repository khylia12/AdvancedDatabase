<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="AdvancedDatabase2.Payment" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-9">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="EmpId" runat="server" placeholder="Employee Id"></asp:TextBox>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">            
                            <asp:TextBox CssClass="form-control" ID="AdminAc" runat="server" placeholder="Admin Account Balance"></asp:TextBox>                        
                        </div>
                        <label>Employee Balance</label>
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="EmpBal" runat="server" placeholder="Employee Account Balance"></asp:TextBox>
                          </div>
                     </div>
                     <div class="col-md-6">
                        <label>Amount Transfering</label>
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="Trans" runat="server" placeholder="Amount Transfering"></asp:TextBox>
                   </div>
                        </div>
                     </div>
